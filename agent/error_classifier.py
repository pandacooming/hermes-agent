...
def classify_api_error(
    ...
    *,
    ...
    error_msg = f"{_raw_msg} {_body_msg}".strip() if _body_msg and _body_msg not in _raw_msg else _raw_msg
    ...
    if (
        status_code == 400
        and "anthropic" in provider_lower
    ...
    if is_disconnect and not status_code:
        is_large = approx_tokens > context_length * 0.6 or approx_tokens > 120000
        if is_large:
            return _result(
